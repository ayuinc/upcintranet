...
<?php
    ...
    public function lista_cursos_dictados_link_alumnos_profesor(){
      ...
      for ($i=0; $i<$tamano; $i++) {
        ...
        for ($a=0; $a<$tamano; $a++) {
          $result .= '<ul class="tr bg-muted">';
          $result .= '<li class="col-xs-9 helvetica-10 pb-0">';
          $result .= '<div>';
          $result .= '<span>'.$json['modalidades'][$i]['cursos'][$a]['curso'].'</span>';
          $result .= '</div>';
          $result .= '</li>';
          $result .= '<li class="col-xs-3 helvetica-10">';
          $result .= '<div class="text-center">';
          $result .= '<span>';
          ...
          $result .= '<input type="submit" class="btn btn-custom" value="Alumnos" name="submit">';
          $result .= '</form>';
          $result .= '</span>';
          $result .= '</div>';
          $result .= '</li>';         
    ...
    public function lista_alumnos_matriculados_en_curso_por_profesor(){
      ...
      for ($i=0; $i<$tamano; $i++) {
        ...
        for ($a=0; $a<$tamano_int; $a++) {
          ...
          $result .= '<input type="submit" class="btn btn-custom" name="submit" value="Ver Notas">';
          $result .= '</form>'; 
          $result .= '</span>';                 
          $result .= '</div>';
          $result .= '</li>';         
