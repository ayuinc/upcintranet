...
<input name="channel_files_file" type="file">
<input name="file_id" value="<?=$file_id?>" type="hidden">

<br><br>
<input type="submit" value="<?=lang('cf:actions:replace')?>" class="btn btn-primary" id="uploadfilebtn" onclick="document.getElementById('uploadfilebtn').className = 'btn btn-primary disabled'; ">
<?=form_close()?>
</div>
